...
```{julia} 
options = Options(; time_limit=1.0) # Establishes variables for the optimization function
...
a = a[1,1]
tempa = [Action(a*1u"ft")]
a = []
N_SOW = 10 # Change to 100000 later
for i in 1:N_SOW # Creates N_SOW long vector to be applied to the SOW's later in the function
    a = append!(a, tempa) 
end
slr_scenarios = let
...
let
    scatter(
        ...
        label="The average negative NPV for elevating an apartment at different elevations under 100,000 different SOW's",
        legend=:topright,
        size=(800, 400),
